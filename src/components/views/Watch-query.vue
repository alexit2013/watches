<template>
  <div class="watch-query-container" id="watch-query">
              ...
              <el-row :gutter="24">
                <el-col :span="12">
                  <el-form-item label="品牌：" placeholder="请选择" class="el-form-item">
                    <el-select v-model="brand" @change="selectGoodsByGroupId($event)" clearable>
          ...
          <div v-show="watchFlag == 1">
            ...
            <el-dialog title="增加手表" :visible.sync="dialogAddWatchVisible" center :close-on-press-escape="false"
                    ...
                    <el-form-item label="" style="width: 100%;" v-for="(price,index) in publicPriceList" :key="index">
                      <div style="width: 100%;">
                        ...
                        <el-button type="primary" style="width: 100px;height: 40px;margin-left: 10px;font-size: 14px;"
                          @click="updatePrice(index)">修改</el-button>
                        <el-button type="primary" style="width: 100px;height: 40px;font-size: 14px;"
                          @click="deletePrice(index)">删除</el-button>
                      </div>
                    </el-form-item>
              ...
              <div slot="footer">
                ...
                <el-button type="primary" @click="addWatchSure">确 定</el-button>
              </div>
            </el-dialog>
          </div>
        </div>
                ...
                <td>
                  ...
                  <el-tooltip class="item" effect="light" content="修改信息" placement="top-end">
                    <img src="../../assets/imgs/update.png" style="margin-left: 30px;cursor:pointer;"
                      v-show="watchFlag == 1" @click="watchUpdate(item)" />
                  </el-tooltip>
                  ...
                  <el-dialog title="修改手表信息" :visible.sync="dialogUpdateWatchVisible" center
                          ...
                          <el-form-item label="公价：">
                            <div style="width: 100%;">
                              ...
                              <el-button style="width: 100px;height: 40px;margin-left: 10px;font-size: 14px;"
                                type="primary" @click="addPrice">增加</el-button>
                            </div>
                          </el-form-item>
                    ...
                    <div slot="footer">
                      ...
                      <el-button type="primary" @click="UpdateWatchSure">确 定</el-button>
                    </div>
                  </el-dialog>
                </td>
              </tr>
        ...
        <div style="width: 60%;margin: 0 auto;">
          ...
          <div>
            ...
            <div style="width: 90%;margin: 0 auto;">
              ...
              <div style="display: flex;">
                <p>
                  批发价：{{watchSelectDetails.marketPrice == 0 || watchSelectDetails.marketPrice == null ? '暂无' : formatNumberRgx(watchSelectDetails.marketPrice)}}
                </p>
                <p style="margin-left: 15px;color: #0aa1ed;cursor: pointer;"
                  v-show="watchSelectDetails.marketPrice !== 0 && watchSelectDetails.marketPrice !== null "
    ...
    <div>
      <Price-inquire-details v-if="watchQuerySel.select == 2" :priceDetailsList="priceDetailsList"
