    ...
    <div class="peer-table">
      <div class="addBtn" @click="addPeer">
        <span class="add-style">
          <span>+</span> {{role == 2 ? '新增贸易商' : '新增客户'}}
        </span>
      </div>
      <el-dialog :title="role == 2 ? '新增贸易商' : '新增客户'" :visible.sync="dialogAddPeerVisible" center
        ...
        <el-form label-width="120px">
          <el-form-item label="类型：" required>
            <el-radio-group v-model="type">
              ...
              <el-radio :label="2" v-show="role == 4">散客</el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item label="名称：" required>
            <el-input v-model="name" :placeholder="role == 2 ? '请输入贸易商名称' : '请输入客户名称'" class="input-style"></el-input>
          </el-form-item>
        ...
        <table>
          ...
          <tr v-for="(item,index) of dataPeerList" :key="index">
            ...
            <td>
              ...
              <el-dialog :title="role == 2 ? '修改贸易商信息' : '修改客户信息'" center :visible.sync="dialogUpdatePeerVisible">
                <el-form label-width="120px">
                  <el-form-item label="类型：" required>
                    <el-radio-group v-model="type">
                      <el-radio :label="0">贸易商公司</el-radio>
                  ...
                  <el-form-item label="名称：" required>
                    <el-input v-model="name" :placeholder="role == 2 ? '请输入贸易商名称' : '请输入客户名称'" class="input-style">
                    </el-input>
                  </el-form-item>
                  <el-form-item label="国家：" required>
                    <el-select v-model="country" placeholder="请选择" class="input-style">
              ...
              <el-dialog :title="role == 2 ? '删除贸易商' : '删除客户'" center :visible.sync="dialogDeletPeerVisible">
              ...
              <el-tooltip class="item" effect="light" content="新建采购单" placement="top-end">
                <img src="../../assets/imgs/add.png" style="margin-left: 30px;cursor:pointer;" v-if="role == 2"
